...
urlpatterns = [
    ...
    path('adicionar_material/<int:pk>/<str:tipo>', views.adicionar_material, name='adicionar_material'),
    ...
    path('vincular_conteudo/<int:turma_id>', views.vincular_conteudo, name='vincular_conteudo'),
    path('vincular_conteudo/<int:turma_id>/<int:aula_id>', views.vincular, name='vincular'),
